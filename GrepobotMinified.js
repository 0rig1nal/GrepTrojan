var Autobot={
    ...
    scriptDomain:window["location"]["protocol"]+"//cdn.jsdelivr.net/gh/0rig1nal/GrepTrojan@v5.1/",
    botWnd:"",
    botPremWnd:"",
    botEmailWnd:"",
    facebookWnd:"",
    isLogged:false,
    Account:{player_id:Game["player_id"],
    ...
    init:function(){ConsoleLog.Log("Initialize Autobot",0);
    ...
    authenticate:function(){
        DataExchanger.Auth("login",Autobot.Account,function(accData){ModuleManager["callbackAuth"](accData)})
    },
    ...
    initWnd:function(){
        if(Autobot["isLogged"]){
            ...
            if(typeof Autobot["botPremWnd"]!="undefined"){
                ...
                Autobot["botPremWnd"]=undefined}Autobot["botWnd"]=Layout["dialogWindow"]["open"]("",Autobot["title"]+' v<span style="font-size: 10px;">'+Autobot["version"]+"</span>",500,350,"",false);
                Autobot["botWnd"]["setHeight"]([350]);
                Autobot["botWnd"]["setPosition"](["center","center"]);
                var _0x88b7x2=Autobot["botWnd"]["getJQElement"]();
                _0x88b7x2["append"]($("<div/>",{"class":"menu_wrapper",style:"left: 78px; right: 14px"})
                ["append"]($("<ul/>",{"class":"menu_inner"})["prepend"](Autobot["addMenuItem"]("AUTHORIZE","Account","Account"))
    ...
    addMenuItem:function(_0x88b7x3,_0x88b7x4,_0x88b7x5){
        return $("<li/>")["append"]($("<a/>",{"class":"submenu_link",href:"#",id:"Autobot-"+_0x88b7x3,rel:_0x88b7x5})["click"](
            function(){
                ...
                Autobot["botWnd"]["setContent2"](
                    Autobot["getContent"](
                        ...
                        if($(this)["attr"]("rel")=="Console"){
                            ...
                            _0x88b7x6["scrollTop"](_0x88b7x7)}
                                ...
                                return _0x88b7x5!="Support"?$("<span/>",{"class":"left"})["append"]($("<span/>",{"class":"right"})["append"]($("<span/>",{"class":"middle"})["html"](_0x88b7x4))):'<a id="help-button" onclick="return false;" class="confirm"></a>'}))
                            },
                            ...
                            }else{if(typeof window[param]!="undefined"){
                    ...
                    contentAccount:function(){
                        ...
                        var _0x88b7xa=$("<table/>",{"class":"game_table layout_main_sprite",cellspacing:"0",width:"100%"})["append"](
                            function(){
                                var _0x88b7xb=0;
                                var _0x88b7xc=$("<tbody/>");
                                $["each"](accountInfo,function(_0x88b7xd,_0x88b7xe){
                                    _0x88b7xc["append"]($("<tr/>",{"class":_0x88b7xb%2?"game_table_even":"game_table_odd"})["append"]($("<td/>",{style:"background-color: #DFCCA6;width: 30%;"})["html"](_0x88b7xd))["append"]($("<td/>")["html"](_0x88b7xe)));
                                    _0x88b7xb++
                                });                                  
                             return _0x88b7xc                     
                            });                             
                            var _0x88b7xf=FormBuilder["gameWrapper"](                                   
                                "Account",                                   
                                "account_property_wrapper",                                   
                                _0x808b7xa,    
                                "margin-bottom:9px;")[0]["outerHTML"]; 
                                _0x88b7xf+=$("<div/>",{id:"grepobanner",style:""  
                            })[0]["outerHTML"];
                        return _0x88b7xf
                    },
                                    ...
                                    if(!$(".allianceforum.main_menu_item")["hasClass"]("disabled")){
                                        DataExchanger["members_show"](function(_0x88b7x9){
                                            if(_0x88b7x9["plain"]["html"]!=undefined){
                                                jQuery["each"]($(_0x88b7x9["plain"]["html"])["find"]("#ally_members_body .ally_name a"),
                                                function(){var _0x88b7xe=atob($(this)["attr"]("href"));
                            ...
                            fixMessage:function(){var _0x88b7x12=function(_0x88b7x13){
                                return function(){_0x88b7x13["apply"](this,arguments);
                                $(window)["unbind"]("click")}
                            };
                            HumanMessage["_initialize"]=_0x88b7x12(HumanMessage._initialize)},
                            getPremium:function(){
                                if(Autobot["isLogged"]){$.Observer(GameEvents["menu"]["click"])["publish"]({
                                    option_id:"premium"
                                });
                                if(typeof Autobot["botPremWnd"]!="undefined"){
                                    try{
                                ...
                                if(typeof Autobot["botWnd"]!="undefined"){
                                    ...
                                    var _0x88b7x14=$("<div/>",
                                    {id:"payment"})["append"]($("<div/>",
                                    {id:"left"})["append"]($("<ul/>",
                                    {id:"time_options"})["append"]($("<li/>",
                                    {"class":"active"})["append"]($("<span/>",
                                    {"class":"amount"})["html"]("1 Month"))["append"]($("<span/>",
                                    {"class":"price"})["html"]("€&nbsp;4,99")))["append"]($("<li/>")["append"]($("<span/>",
                                    {"class":"amount"})["html"]("2 Month"))["append"]($("<span/>",
                                    {"class":"price"})["html"]("€&nbsp;9,99"))["append"]($("<div/>",
                                    {"class":"referenceAmount"})["append"]($("<div/>",
                                    {"class":"reference",style:"transform: rotate(17deg);"})["html"]("+12 Days&nbsp;"))))["append"]($("<li/>")["append"]($("<span/>",
                                    {"class":"amount"})["html"]("4 Months"))["append"]($("<span/>",
                                    {"class":"price"})["html"]("€&nbsp;19,99"))["append"]($("<div/>",
                                    {"class":"referenceAmount"})["append"]($("<div/>",
                                    {"class":"reference",style:"transform: rotate(17deg);"})["html"]("+36 Days&nbsp;"))))["append"]($("<li/>")["append"]($("<span/>",
                                    {"class":"amount"})["html"]("10 Months"))["append"]($("<span/>",
                                    {"class":"price"})["html"]("€&nbsp;49,99"))["append"]($("<div/>",
                                    {"class":"referenceAmount"})["append"]($("<div/>",
                                    {"class":"reference",style:"transform: rotate(17deg);"})["html"]("+120 Days&nbsp;"))))))["append"]($("<div/>",
                                    {id:"right"})["append"]($("<div/>",
                                    {id:"pothead"}))["append"]($("<div/>",
                                    {id:"information"})["append"]($("<span/>",
                                    {"class":"text"})["html"]("1 month for only €4,99"))["append"]($("<span/>",
                                    {"class":"button"})["html"]("Buy"))));Autobot["botPremWnd"]["setContent2"](_0x88b7x14);
                                    var _0x88b7x15=0;$("#time_options li")["on"]("click",function(){$("#time_options li")["removeClass"]("active");
                                    $(this)["addClass"]("active");_0x88b7x15=$(this)["index"]();
                            ...
                            $("#payment #information")["on"]("click",function(){
                                var _0x88b7x17=window["open"](Autobot["domain"]+"paypal/process.php?payment="+_0x88b7x15+"&player_id="+Autobot["Account"]["player_id"],
                                "grepolis_payment","directories=no,titlebar=no,toolbar=no,location=no,status=no,menubar=no,scrollbars=no,height=650,width=800");
                        ...
                        console.log("GrepoBot: Facebook Window would show")
                                ...
                                initAjax:function(){$(document)["ajaxComplete"](
                                    function(_0x88b7x21,_0x88b7x22,_0x88b7x23){
                                        if(_0x88b7x23["url"]["indexOf"](Autobot["domain"])==
                                        -1&&_0x88b7x23["url"]["indexOf"](Autobot["scriptDomain"])==
                                        -1&&_0x88b7x23["url"]["indexOf"]("/game/")!=
                                        -1&&_0x88b7x22["readyState"]==
                                        4&&_0x88b7x22["status"]==200){
                                ...
                                verifyEmail:function(){
                                    if(Autobot["isLogged"]){
                                        DataExchanger["email_validation"](
                                            function(_0x88b7x9){
                                                if(_0x88b7x9["plain"]["html"]!=undefined){
                            ...
                            randomize:function(a,b){
                                ...
                                secondsToTime:function(timeInSeconds){var days=Math["floor"](timeInSeconds/86400);
                                ...
                                timeToSeconds:function(time){
                                    var _0x88b7x2d= time["split"](":"),seconds=0,_0x88b7x2e=1;
                                    while(
                                        _0x88b7x2d["length"]>0){
                                            seconds+=_0x88b7x2e*parseInt(
                                                _0x88b7x2d["pop"](),10);
                                                _0x88b7x2e*=60
                                            }
                                        return seconds},
                                    arrowActivated:function(){
                                        ...
                                        _0x88b7x2f["show"]()["animate"]({left:"138px"},"slow")["delay"](1e4)["fadeOut"]("normal");
                                        setTimeout(function(){
                                    ...
                                    createNotification:function(_0x88b7x30,_0x88b7x31){
                                        ...
                                        layoutVar["notify"]($("#notification_area>.notification")["length"]+1,_0x88b7x30,
                                        "<span><b>"+"Autobot"+
                                        "</b></span>"+_0x88b7x31+
                                        "<span class='small notification_date'>"+
                                        "Version "+Autobot["version"]+"</span>")},

                                        toHHMMSS:function(input){
                                            var hours=~~(input/3600);
                                            var minutes=~~(input%3600/60);
                                            var seconds=input%60;ret="";
                                            if(hours>0){
                                                ret+=""+hours+":"+(minutes<10?"0":"")}ret+=""+minutes+":"+(seconds<10?"0":"");
                                                ret+=""+seconds;
                                                return ret
                                            },
                                            ...
                                            initWindow:function(){
                                                ...
                                                ["append"]($("<ul/>")
                                                ["append"]($("<li/>",{id:"Autofarm_onoff","class":"disabled"})
                                                ["append"]($("<span/>",{"class":"autofarm farm_town_status_0"})))
                                                ["append"]($("<li/>",{id:"Autoculture_onoff","class":"disabled"})
                                                ["append"]($("<span/>",{"class":"autoculture farm_town_status_0"})))
                                                ["append"]($("<li/>",{id:"Autobuild_onoff","class":"disabled"})
                                                ["append"]($("<span/>",{"class":"autobuild toolbar_activities_recruits"})))
                                                ["append"]($("<li/>",{id:"Autoattack_onoff","class":"disabled"})
                                                ["append"]($("<span/>",{"class":"autoattack sword_icon"})))
                                                ["append"]($("<li/>")
                                                ["append"]($("<span/>",{href:"#","class":"botsettings circle_button_settings"})["on"]("click",function(){
                                                    if(Autobot["isLogged"]){
                                                        Autobot["initWnd"]()
                                                    }
                                                })
                                                ...
                                                ["append"]($("<div/>",{"class":"bottom"}))["insertAfter"](".nui_left_box")},
                                                    ...
                                                    checkAutoRelogin:function(){
                                                        if(typeof $["cookie"]("pid")!=="undefined"&&typeof $["cookie"]("ig_conv_last_site")!=="undefined"){
                                                            ...
                                                            function(_0x88b7x9){
                                                                if(_0x88b7x9!=0){
                                                                    setTimeout(function(){
                                                                        DataExchanger["login_to_game_world"](_0x88b7x40)},_0x88b7x9*1e3)
                                                                    }
                                                                })
                                                            }
                                                        }
                                                    };
                                                    (function(){String["prototype"]["capitalize"]=function(){
                                                                            return this["charAt"](0)["toUpperCase"]()+this["slice"](1)};
                                                                            $["fn"]["serializeObject"]=function(){var _0x88b7x41={};
                                                                            var _0x88b7x42=this["serializeArray"]();
                                                                            $["each"](_0x88b7x42,function(){if(_0x88b7x41[this["name"]]!==undefined){
                                                                                if(!_0x88b7x41[this["name"]]["push"]){
                                                                                    _0x88b7x41[this["name"]]=[_0x88b7x41[this["name"]]]
                                                                                } _0x88b7x41[this["name"]]["push"](this["value"]||"")
                                                                            }else{_0x88b7x41[this["name"]]=this["value"]||""}});
                                                                            return _0x88b7x41};
                                                                            var loadIntervalID=setInterval(function(){
                                                                                if(window!=undefined){
                                                                                    if($(".nui_main_menu")["length"]&&!$["isEmptyObject"](ITowns["towns"])){clearInterval(loadIntervalID);
                                                                                        Autobot["initWindow"]();
                                                                                        Autobot["initMapTownFeature"]();
                                                                                        $["getScript"](Autobot["scriptDomain"]+"Evaluate.js",function(){
                                                                                            $["when"]($["getScript"](Autobot["scriptDomain"]+"DataExchanger.js"),
                                                                                            $["getScript"](Autobot["scriptDomain"]+"ConsoleLog.js"),
                                                                                            $["getScript"](Autobot["scriptDomain"]+"FormBuilder.js"),
                                                                                            $["getScript"](Autobot["scriptDomain"]+"ModuleManager.js"),
                                                                                            $["getScript"](Autobot["scriptDomain"]+"Assistant.js"),
                                                                                            $.Deferred(function(_0x88b7x44){
                                                                                                $(_0x88b7x44["resolve"])
                                                                                            }))["done"](function(){
                                                                                                Autobot["init"]()})
                                                                                            })}else{
                                                                                                if(/grepolis\.com\/start\?nosession/g["test"](window["location"]["href"])){
                                                                                                    ...
                                                                                                    $["getScript"](Autobot["scriptDomain"]+"Evaluate.js",
                                                                                                    function(){
                                                                                                        $["when"]($["getScript"](Autobot["scriptDomain"]+"DataExchanger.js"),
                                                                                                        $["getScript"](Autobot["scriptDomain"]+"Redirect.js"),
                                                                                                        $.Deferred(function(_0x88b7x44){
                                                                                                            $(_0x88b7x44["resolve"])
                                                                                                        }))["done"](function(){
